...
<body>
    <div class='boxCreate'>
        <form method="post" enctype='multipart/form-data'>
            <div class="mb-3">
                <input type="text" class="form-control" name="categoryname" placeholder='Nhập vào tên danh muc'>
                <span style="color: red;"><?= $errors['l1'] ?? ''?></span>
            </div>
            <button type="submit" class="btn btn-primary col-12">Create category</button>   
        </form>
    </div>
</body>
</html>
